...
inline std::string to_yaml(const MoveJoints_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use interface::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const interface::srv::MoveJoints_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  interface::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use interface::srv::to_yaml() instead")]]
inline std::string to_yaml(const interface::srv::MoveJoints_Event & msg)
{
  return interface::srv::to_yaml(msg);
}

template<>
inline const char * data_type<interface::srv::MoveJoints_Event>()
{
  return "interface::srv::MoveJoints_Event";
}

template<>
inline const char * name<interface::srv::MoveJoints_Event>()
{
  return "interface/srv/MoveJoints_Event";
}

template<>
struct has_fixed_size<interface::srv::MoveJoints_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<interface::srv::MoveJoints_Event>
  : std::integral_constant<bool, has_bounded_size<interface::srv::MoveJoints_Request>::value && has_bounded_size<interface::srv::MoveJoints_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<interface::srv::MoveJoints_Event>
  : std::true_type {};
